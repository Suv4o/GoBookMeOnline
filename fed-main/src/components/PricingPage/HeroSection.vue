...
const tiers = [
  {
    ...
    priceMonthly: 0,
    description:
      'This is the best plan for personal use and if you are just starting out. It is free forever and you can upgrade to a paid plan at any time.',
    roleType: Roles.PROVIDER_DEFAULT,
    features: ['Only 1 resource for personal use', 'Up to 100 bookings', 'Basic analytics'],
  },
  {
    name: 'Scale',
    href: 'signup',
    priceMonthly: 29,
    description:
      'This plan is for you if you are a business that is growing. For small businesses you have an option for single location. Or you can add multiple locations for larger businesses.',
    roleType: Roles.PROVIDER_PAYED,
    features: [
      'Unlimited resources',
      'Up to 1000 bookings per location (additional booking $0.04)',
      'Multiple locations, 2 included (additional location $5.99)',
      'Ability to add other users as resources',
      'Included 1000 email for clients communication (additional $5 per 1000 Emails)',
      'Included 100 SMS for client communication (additional $10 per 100 SMS)',
      'Web Widget',
      'Tech Support',
    ],
  },
