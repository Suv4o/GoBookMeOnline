...
import BookMainNav from '../global/BookMainNav/BookMainNav.vue'
  ...
  <div class="relative overflow-hidden">
    <div class="hidden sm:block sm:absolute sm:inset-0" aria-hidden="true">
      ...
      >
        ...
        <rect width="364" height="384" class="text-gray-200" fill="url(#eab71dd9-9d7a-47bd-8044-256344ee00d0)" />
      </svg>
    </div>
            ...
            >
              <div>
                ...
                >
                  ...
                  {{ ' ' }}
                  <span class="text-teal-400 md:block">online business</span>
                </h1>
